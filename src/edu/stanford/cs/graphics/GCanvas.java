 ...
 * File: GCanvas.java
 * ------------------
 * This file exports a canvas to which various graphical shapes can be added.
 */
...
/**
 * Removes all graphical objects from the canvas.  This method is a synonym
 ...
 */
   ...
   public final void setPreferredSize(double width, double height) {
      setPreferredSize(new Dimension(GMath.round(width),
                                     GMath.round(height)));
   }
